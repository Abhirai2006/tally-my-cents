...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tally — Personal Expense & Income Ledger" },
      {
        name: "description",
        content:
          "Tally is a calm, paper-styled ledger for logging daily expenses and income, with monthly charts and CSV export.",
      },
